        ...
        <body>
            <div class="flex ">
                ...
                <div
                    ...
                    <a href="abc"
                        class="text-lg text-blue-800 font-bold flex justify-end mr-5 mt-5 hover:underline">Edit</a>
                    <div class="pl-[3cm]">
                ...
                <div>
                    ...
                    <div
                        ...
                        <div class="flex space-x-15">
                            ...
                            <a href="profile1.php" class="text-sm">Documents & Certificates</a>
                    ...
                    <div class="bg-white p-6  rounded-lg shadow-md mt-4 ml-8 w-200">
                        <h2 class="text-lg font-extrabold text-gray-700 mb-4 text-center">Upload Documents</h2>
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-600 mb-1">Upload Identity Proof:</label>
                            <input id="upload-id" type="file" class="w-full p-2 border border-gray-300 rounded-md  cursor-pointer">
                        </div>

                        <div class="mb-4">
                            <label class="block text-gray-600 mb-1">Upload Category Certificate:</label>
                            <input id="upload-category" type="file" class="w-full p-2 border border-gray-300 rounded-md  cursor-pointer">
                        </div>
                        <div class="mb-4">
                            <button class="w-full bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600  cursor-pointer">
                                <a href="admit-card.pdf" download>Download Admit Card (PDF)</a>
                            </button>
                        </div>
                        <div class="mb-4">
                            <button class="w-full bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600  cursor-pointer">
