                ...
                <div>
                    ...
                    <div
                        ...
                        <div class="flex space-x-15">
                            <a href="profile1.php" class="text-sm">Academic Details</a>
                    ...
                    <div class="mt-8 ">
                        <form class="max-w-md mx-auto p-5 transition-transform duration-300 hover:scale-105 hover:z-10 border shadow-2xl shadow-gray-400 rounded-xl border-gray-300">
                            <div class="flex items-center gap-4 mb-4">
                                <label for="Percenatage12" class="font-bold text-gray-800 w-40">12th Percentage:</label>
                                <input type="text" id="Percenatage12" class="p-2 border border-blue-400 rounded-md w-48"disabled value="87%">
                            </div>
                            <div class="flex items-center gap-4 mb-4">
                                <label for="Percenatage10" class="font-bold text-gray-800 w-40">10th Percentage:</label>
                                <input type="text" id="Percenatage10" class="p-2 border border-blue-400 rounded-md w-48" disabled value="90%">
                            </div>
                            <div class="flex items-center gap-4 mb-4">
                                <label for="school" class="font-bold text-gray-800 w-40 pl-1.5">School Name:</label>
                                <input type="text" id="school" class="p-2 border border-blue-400 rounded-md w-48" disabled value="XYZ School">
                            </div>
                            <div class="flex items-center gap-4 mb-4">
                                <label for="Board" class="font-bold text-gray-800 w-40">University Board:</label>
                                <input type="text" id="Board" class="p-2 border border-blue-400 rounded-md w-48" disabled value="XYZ Board">
                            </div>
                            <div class="flex items-center gap-4 mb-4">
                                <label for="EnrollmentID" class="font-bold text-gray-800 w-40">Enrollment ID:</label>
                                <input type="text" id="EnrollmentID" class="p-2 border border-blue-400 rounded-md w-48" disabled value="STU20250415001">
                            </div>
                            <a href="EditAD.php" class="w-1/2 p-3 ml-40 bg-blue-600 text-white font-bold rounded-md hover:bg-blue-700 cursor-pointer text-center block">Edit</a>
