                ...
                <div>
                    ...
                    <div
                        ...
                        <div class="flex space-x-15">
                            ...
                            <a href="profile1.php" class="text-sm">Exam Information</a>
                    ...
                    <br>
                            ...
                            <div class="bg-white-300 shadow-2xl text-center p-6 h-8  transition-transform duration-300 hover:scale-105 hover:z-10 ml-5 ">
                            <div class="max-w-4xl mx-auto">
                                <h2 class="text-2xl font-semibold mb-4 mt-4">Examination Information</h2>
                                <!-- <button onclick="toggleExamHistory()" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-700">Show Exam History</button> -->
                                
                                <table id="examHistory" class="w-full border-collapse border mt-10">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr class="border">
                                            <td class="border px-4 py-2">Math Test</td>
                                            <td class="border px-4 py-2">2025-03-10</td>
                                            <td class="border px-4 py-2">60 mins</td>
                                            <td class="border px-4 py-2">10:00 AM</td>
                                            <td class="border px-4 py-2">Pass</td>
                                        </tr>
                                        <tr class="border">
                                            <td class="border px-4 py-2">Physics Quiz</td>
                                            <td class="border px-4 py-2">2025-01-15</td>
                                            <td class="border px-4 py-2">45 mins</td>
                                            <td class="border px-4 py-2">02:00 PM</td>
                                            <td class="border px-4 py-2">Fail</td>
                                        </tr>
                                        <tr class="border">
                                            <td class="border px-4 py-2">Chemistry Test</td>
                                            <td class="border px-4 py-2">2025-01-20</td>
                                            <td class="border px-4 py-2">60 mins</td>
                                        ...
                                        <tr class="border">
                                            <td class="border px-4 py-2">Physics Quiz</td>
                                            <td class="border px-4 py-2">2025-02-15</td>
                                            <td class="border px-4 py-2">45 mins</td>
                                            <td class="border px-4 py-2">02:00 PM</td>
                                            <td class="border px-4 py-2">Fail</td>
                                        </tr>
                                        <tr class="border">
                                            <td class="border px-4 py-2">Biology Quiz</td>
                                            <td class="border px-4 py-2">2025-02-20</td>
                                            <td class="border px-4 py-2">45 mins</td>
                                            <td class="border px-4 py-2">02:00 PM</td>
                                            <td class="border px-4 py-2">Fail</td>
                                        </tr>
                                        <tr class="border">
                                            <td class="border px-4 py-2">Aptitude Test</td>
                                            <td class="border px-4 py-2">2025-03-01</td>
                                            <td class="border px-4 py-2">60 mins</td>
